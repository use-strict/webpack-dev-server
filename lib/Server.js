        ...
        if (stats.hasErrors()) {
            ...
            errors.forEach(function(err) {
                output.errors.push({
                    ...
                    rawMessage: err.rawMessage ? stripAnsi(err.rawMessage) : undefined,
                    location: err.location ? err.location : undefined,
                    file: err.file ? err.file : err.module.resource,
                    error: err.error ? {
                    ...
                    loc: (err.dependencies && err.dependencies[0]) ? err.dependencies[0].loc : undefined
                });
            });
        }
